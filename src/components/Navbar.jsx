...
function Navbar() {
  ...
  return (
    <nav className="border-bottom sticky-top bg-light">
      <div className="row justify-content-center container-xxl mx-auto">
        <div className="navbar navbar-expand-md bg-transparent p-3 col-9 col-md-10">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            ...
            >
              <input
                ...
                ref={searchBar}
              />
              <button className="btn btn-danger bg-gradient" type="submit">
                <i className="bi bi-search" />
              </button>
            </form>
          </div>
        </div>
        <div className="col-3 col-md-2 py-3 d-flex bg-transparent justify-content-end">
          <NavLink to="/cart">
            <button
              type="button"
